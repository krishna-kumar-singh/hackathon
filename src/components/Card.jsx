...
export function Card({title,content}) {
    return (
      <div className='w-48 rounded-xl border border-gray-700 hover:bg-gradient-to-r from-yellow-100 to-green-300 hover:bg-opacity-70 p-4 transition duration-300 transform hover:scale-105'>
